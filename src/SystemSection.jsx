...
const QUIZ_RECS = {
  ...
  nightlife_mid: { pick: "Munich Oktoberfest", why: "Event-driven nightlife at its peak. Augustiner tent strategy, Glockenbachviertel base, cost model for groups of 4-10.", alt: "Barcelona + Madrid", altWhy: "100+ validated spots and Madrid nightlife.", link: "/munich" },
  nightlife_high: { pick: "Thailand NYE", why: "Full Moon Party, Bangkok rooftops, Krabi beach clubs. Cathay Pacific via Hong Kong.", alt: "Barcelona + Madrid", altWhy: "Barcelona's nightlife runs until 6am.", link: "/thailand" },
  nightlife_flex: { pick: "Thailand NYE", why: "Full Moon Party, Bangkok rooftops, Krabi beach clubs. Cathay Pacific via Hong Kong.", alt: "Barcelona + Madrid", altWhy: "Barcelona's nightlife runs until 6am.", link: "/thailand" },
  culture_low: { pick: "Prague + Vienna + Dresden", why: "Best value culture cities in Europe. St. Vitus, Schonbrunn, Pilsner Urquell — all on a budget.", alt: "Dublin + Galway", altWhy: "Literary pubs, medieval castles, Cliffs of Moher under $2K.", link: "/prague" },
  culture_mid: { pick: "Rome + Italy", why: "Deepest culture framework. Vatican Jubilee, Pompeii 11/10, Trastevere routing, 43 spots.", alt: "Barcelona + Madrid", altWhy: "Sagrada Familia, Montserrat, the Prado.", link: "/rome" },
  culture_high: { pick: "Australia + NZ", why: "Six weeks of depth. Opera House, Aboriginal experiences, Tasmania, South Island.", alt: "Rome + Italy extended", altWhy: "Add Amalfi and Florence for 10-day deep dive.", link: "/australia" },
  culture_flex: { pick: "Australia + NZ", why: "Six weeks of depth. Opera House, Aboriginal experiences, Tasmania, South Island.", alt: "Rome + Italy extended", altWhy: "Add Amalfi and Florence for 10-day deep dive.", link: "/australia" },
  adventure_low: { pick: "Iceland", why: "Ring Road at any budget. Northern Lights or Midnight Sun. Four versions.", alt: "Smoky Mountains", altWhy: "Cabin, fall colors, minimal flight cost.", link: "/iceland" },
  adventure_mid: { pick: "Iceland", why: "Ring Road at any budget. Northern Lights or Midnight Sun. Four versions.", alt: "Costa Rica", altWhy: "ATV tour, surf lessons, best half-day experience anywhere.", link: "/iceland" },
  adventure_high: { pick: "Iceland", why: "Ring Road at any budget. Volcanic landscapes, waterfalls, Westman Islands.", alt: "Peru / Machu Picchu", altWhy: "Salkantay Trek, Rainbow Mountain — Brady's doing it May 2026.", link: "/iceland" },
  adventure_flex: { pick: "Iceland", why: "Ring Road at any budget. Volcanic landscapes, waterfalls, Westman Islands.", alt: "Peru / Machu Picchu", altWhy: "Salkantay Trek, Rainbow Mountain — Brady's doing it May 2026.", link: "/iceland" },
  ...
  food_mid: { pick: "Barcelona + Madrid", why: "100+ spots, tapas culture, two study abroads of knowledge. Boqueria, pintxos, churros.", alt: "Rome + Italy", altWhy: "Trastevere trattorias, cacio e pepe, one-euro espresso.", link: "/spain" },
  food_high: { pick: "Rome + Italy Extended", why: "Trastevere deep dive. Tonnarello, Bar San Calisto. Extend to Amalfi for seafood.", alt: "Barcelona + Madrid", altWhy: "Switch to Spain's variety if Italian food fatigue is possible.", link: "/rome" },
  food_flex: { pick: "Rome + Italy Extended", why: "Trastevere deep dive. Tonnarello, Bar San Calisto. Extend to Amalfi for seafood.", alt: "Barcelona + Madrid", altWhy: "Switch to Spain's variety if Italian food fatigue is possible.", link: "/rome" },
  mix_low: { pick: "Poland August", why: "Best value. Krakow nightlife, Auschwitz, Gdansk beaches, Warsaw old town. LOT direct from ORD.", alt: "Dublin + Galway", altWhy: "Pubs, castles, cliffs — balanced under $2K.", link: "/poland" },
  mix_mid: { pick: "Barcelona + Madrid", why: "Most validated mix. Two study abroads, 100+ spots, nightlife, Sagrada, Montserrat, tapas, beaches.", alt: "Rome + Italy", altWhy: "Swap beaches for history, keep nightlife and food.", link: "/spain" },

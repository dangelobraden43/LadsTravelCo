...
function useCountUp(target, duration = 1500) {
  ...
  useEffect(() => {
    ...
    if (isNaN(num)) {
      Promise.resolve().then(() => setCount(target))
      return
    }
...
const PROCESS_STEPS = [
  {
    ...
    desc: '90 seconds. Where, who, when, budget.',
    example: 'intake',
    exampleText: '"Barcelona, group of 6, September, $3K budget, nightlife + food focused"',
  },
  {
    num: '02',
    title: '15-Minute Call',
    desc: "We ask the questions you didn't know to ask.",
    example: 'quote',
    exampleText:
      '"You said Barcelona — have you considered September instead of July? 10 degrees cooler, half the crowds, La Merce festival. Here\'s why."',
  },
  {
    num: '03',
    title: 'Research Runs',
    desc: 'Six AI agents build your intelligence layer.',
    example: 'agents',
    agents: [
      'Flight Scanner',
  ...
  },
  {
    ...
    desc: "Plans change — we're here when they do.",
    example: 'followup',
    exampleText:
      '"Hey, those ORD\u2192Dublin flights dropped to $485. Book today \u2014 they won\'t last."',
  },
]
...
const FLIGHT_STRATEGIES = [
  {
    num: '01',
    title: 'How Airline Pricing Works',
    desc: 'Airlines use dynamic pricing algorithms. A seat can cost $400 or $1,200 depending on when you book and what fare class is available. We monitor when cheap buckets reopen.',
  },
  {
    num: '02',
    title: 'The Booking Window',
    desc: 'Optimal: 6–10 weeks out for economy, 4–8 for off-peak, 8–14 for peak summer. We track routes and alert when fares drop below target thresholds.',
  },
  {
    num: '03',
    title: 'Google Flights',
    desc: 'The single best flight search tool. Free. Searches direct airline inventory, shows fare calendars, tracks prices. The Explore map, date grid, and alerts — we use all four.',
  },
  {
    num: '04',
    title: 'Error Fares',
    desc: 'Airlines accidentally publish wrong prices. A $900 flight appears for $280. They honor them ~70% of the time. We monitor sources and alert immediately. Window: 2–6 hours.',
  },
  {
    num: '05',
    title: 'Flexible Dates',
    desc: 'Tuesday vs Friday saves $150–300 per person transatlantic. Mid-week flights are consistently cheaper. We map the full fare landscape for every route.',
  },
  {
    num: '06',
    title: 'Open-Jaw Routing',
    desc: 'Fly into one city, out of another. Eliminates backtracking. Saves $200–400 per person vs round-trip plus positioning flights.',
  },
  {
    num: '07',
    title: 'Hub Arbitrage',
    desc: "ORD vs DTW fare differences are dramatic. ORD has more competition = lower fares. For Michigan clients, driving to O'Hare saves $200+ per person.",
    table: {
      headers: ['Route', 'From ORD', 'From DTW', 'Savings'],
      rows: [
        ['Dublin', '$480–550', '$650–780', '$170–230'],
        ['Rome', '$580–680', '$720–850', '$140–170'],
        ['Barcelona', '$520–620', '$680–800', '$160–180'],
        ['Warsaw (LOT)', '$550–650', '$750–900', '$200–250'],
        ['Reykjavik', '$380–480', '$520–650', '$140–170'],
      ],
    },
  },
]
...
const FLIGHT_MYTHS = [
  {
    ...
    reality:
      'Airlines reprice dynamically thousands of times daily. The booking day matters far less than the departure day, booking window, and fare class availability.',
  },
  {
    myth: '"Incognito mode gets you cheaper flights"',
    reality:
      "Airlines don't track your search history to raise prices. Price variations are caused by real-time fare class changes, not cookies. Savings from incognito: zero.",
  },
  {
    myth: '"Book 6 months early for the best price"',
    reality:
      'Booking too early = paying the certainty premium. The sweet spot is 6–10 weeks out for international economy, when airlines open cheaper fare classes to fill seats.',
  },
  {
    myth: '"Direct flights are always more expensive"',
    reality:
      'On competitive routes, directs are often cheaper. ORD to Dublin on Aer Lingus direct frequently beats connecting through JFK on American.',
  },
]
...
const DELIVERABLES = [
  ...
  {
    title: 'Flight Intelligence Report',
    desc: 'Route analysis, booking windows, hub arbitrage comparison, error fare monitoring. For your specific dates and airports.',
    preview: 'flights',
  },
  {
  ...
  },
  {
    ...
    desc: 'Per-person cost models for your group size. Accommodation, food, transport, experiences. No surprises.',
    preview: 'money',
  },
  {
    title: 'Personalized Match',
    desc: "Don't know where to go? Take the quiz below. Seven questions and we'll tell you exactly where to start.",
    preview: 'quiz',
  },
]
...
const QUIZ_QUESTIONS = [
    ...
    options: [
      {
        ...
        hasInput: true,
        inputPlaceholder: 'Type your destination...',
      },
      {
        value: 'region',
        label: 'I have a region in mind',
        hasSubOptions: true,
        subOptions: [
          'Europe',
          'Central America',
    ...
    options: [
      {
        ...
        label: 'I have dates',
        hasInput: true,
        inputPlaceholder: 'e.g., September 2026',
      },
      {
        value: 'flexible',
        label: "I'm flexible on timing",
        hasSubOptions: true,
        subOptions: ['Spring', 'Summer', 'Fall', 'Winter'],
      },
  ...
  {
    id: 'been',
    question: 'Where have you already been?',
    subtitle: "So we don't send you somewhere you've done.",
    type: 'text',
    optional: true,
...
const QUIZ_RECS = {
  ...
  nightlife_high: {
    ...
    why: "Barcelona's nightlife runs until 6am. Two cities, one framework — Barcelona meets Madrid.",
    alt: 'Munich Oktoberfest',
    altWhy: 'Event-driven nightlife at its peak.',
    link: '/spain',
  },
  nightlife_flex: {
    pick: 'Barcelona + Madrid',
  ...
  culture_high: {
    pick: 'Australia + NZ',
    why: 'Six weeks of depth. Opera House, Aboriginal experiences, Tasmania, South Island.',
    alt: 'Rome + Italy extended',
    altWhy: 'Add Amalfi and Florence for 10-day deep dive.',
    link: '/australia',
  },
  culture_flex: {
    pick: 'Australia + NZ',
  ...
  adventure_low: {
    pick: 'Iceland',
    why: 'Ring Road at any budget. Northern Lights or Midnight Sun. Four versions.',
    alt: 'Smoky Mountains',
    altWhy: 'Cabin, fall colors, minimal flight cost.',
    link: '/iceland',
  },
  adventure_mid: {
    pick: 'Iceland',
    why: 'Ring Road at any budget. Northern Lights or Midnight Sun. Four versions.',
    alt: 'Costa Rica',
    altWhy: 'ATV tour, surf lessons, best half-day experience anywhere.',
    link: '/iceland',
  },
  adventure_high: {
    pick: 'Iceland',
    why: 'Ring Road at any budget. Volcanic landscapes, waterfalls, Westman Islands.',
    alt: 'Peru / Machu Picchu',
    altWhy: "Salkantay Trek, Rainbow Mountain — Brady's doing it May 2026.",
    link: '/iceland',
  },
  adventure_flex: {
    pick: 'Iceland',
  ...
  food_low: {
    pick: 'Dublin + Galway',
    why: "Pub food plus Galway seafood. McDonagh's, oyster market, 35+ pubs.",
    alt: 'Poland August',
    altWhy: 'Pierogi, zurek, Krakow Kazimierz food scene.',
    link: '/dublin',
  },
  food_mid: {
    pick: 'Barcelona + Madrid',
  ...
  food_high: {
    pick: 'Rome + Italy Extended',
    why: 'Trastevere deep dive. Tonnarello, Bar San Calisto. Extend to Amalfi for seafood.',
    alt: 'Barcelona + Madrid',
    altWhy: "Switch to Spain's variety if Italian food fatigue is possible.",
    link: '/rome',
  },
  food_flex: {
    pick: 'Rome + Italy Extended',
    ...
    <div className="sys-root">
      ...
      <section className="sys-section-light-2">
        <div className="sys-inner">
          ...
          {/* Strategy label */}
          <Reveal>
            <div className="sys-label" style={{ marginTop: 60 }}>
              FLIGHT INTELLIGENCE
            </div>
                ...
                <div className="sys-fi-card">
                  ...
                  {card.table && (
                    <table className="sys-fi-table">
                      <thead>
                        <tr>
                          {card.table.headers.map((h, j) => (
                            <th key={j}>{h}</th>
                          ))}
                        </tr>
                      </thead>
                      <tbody>
                        {card.table.rows.map((row, j) => (
                          <tr key={j}>
                            {row.map((cell, k) => (
                              <td key={k} className={k === 3 ? 'sys-fi-table-gold' : ''}>
                                {cell}
                              </td>
                            ))}
                          </tr>
          ...
          {/* Myths */}
          <Reveal>
            <h3 className="sys-subtitle-light" style={{ marginTop: 60 }}>
              Myths We Bust
            </h3>
          </Reveal>
      ...
      >
        {[
          NEW_IMAGES.rockArchPNW,
          BATCH3_IMAGES.europeanWaterfall,
          NEW_IMAGES.schonbrunnWalk,
          HERO_IMAGES.konaBrewingVwBusHawaii,
        ].map((src, i) => (
            ...
            {DELIVERABLES.map((d, i) => (
              <Reveal key={i} delay={i * 80}>
                <div className="sys-del-card">
                  <div className="sys-del-included">INCLUDED</div>
                  ...
                  <div className="sys-del-preview">
                    {d.preview === 'framework' && (
                      <div className="sys-del-mock">
                        ...
                        <div className="sys-del-mock-dots">
                          <span />
                          <span />
                          <span />
                          <span />
                    ...
                    {d.preview === 'flights' && (
                      <div style={{ fontSize: 11 }}>
                        ...
                        >
                          SAMPLE: OKTOBERFEST 2026 FLIGHTS
                        </div>
                        <div className="sys-del-mini-table">
                          <div className="sys-del-mini-row">
                            <span style={{ fontWeight: 600 }}>Route</span>
                            <span style={{ fontWeight: 600 }}>Price</span>
                          </div>
                          <div className="sys-del-mini-row">
                            <span>ORD→MUC Icelandair (w/ stopover)</span>
                            <span style={{ color: 'var(--gold)' }}>$625–750</span>
                          </div>
                          <div className="sys-del-mini-row">
                            <span>ORD→MUC Lufthansa direct</span>
                            <span>$850–1,100</span>
                          </div>
                          <div className="sys-del-mini-row">
                            <span>DTW→MUC (any carrier)</span>
                        ...
                        <div style={{ marginTop: 8, fontSize: 10, color: 'var(--muted)' }}>
                          Book window: 12–16 weeks out. Icelandair adds free Iceland stopover.
                        </div>
                      </div>
                    )}
                    {d.preview === 'maps' && (
                      <div className="sys-del-maps-grid">
                        {[
                          ...
                          <div key={m} className="sys-del-map-pin">
                    ...
                    {d.preview === 'money' && (
                      <div style={{ fontSize: 11 }}>
                        ...
                        >
                          SAMPLE: ROME 7 DAYS (GROUP OF 4)
                        </div>
                        <div className="sys-del-mini-table">
                          <div className="sys-del-mini-row">
                            <span style={{ fontWeight: 600 }}>Category</span>
                            <span style={{ fontWeight: 600 }}>Typical</span>
                            <span style={{ fontWeight: 600, color: 'var(--gold)' }}>Ours</span>
                          </div>
                          <div className="sys-del-mini-row">
                            <span>Flights (ORD)</span>
                            <span>$950</span>
                            <span style={{ color: 'var(--gold)' }}>$750</span>
                          </div>
                          <div className="sys-del-mini-row">
                            <span>Hotels (7 nights)</span>
                            <span>$700</span>
                            <span style={{ color: 'var(--gold)' }}>$450</span>
                          </div>
                          <div className="sys-del-mini-row">
                          ...
                          >
                            ...
                            <span style={{ color: 'var(--gold)', fontWeight: 700 }}>$1,800</span>
                          </div>
                        </div>
                        <div style={{ marginTop: 6, fontSize: 10, color: 'var(--muted)' }}>
                          Aperitivo strategy saves €50–75/person. We find the neighborhoods, not the
                          tourist traps.
                        </div>
                      </div>
                    )}
        ...
        <div className="sys-inner">
          <Reveal type="fade">
            <div style={{ textAlign: 'center', marginBottom: 48 }}>
              ...
              <p
                className="sys-subtitle-dark"
                style={{ fontStyle: 'normal', color: 'var(--cream2)' }}
              >
                Seven questions. We'll tell you.
              </p>
            </div>
          </Reveal>
          ...
          {!quizStarted && !quizResult && (
            <div style={{ textAlign: 'center' }}>
              <button className="sys-quiz-start" onClick={() => setQuizStarted(true)}>
                Start the Quiz
              </button>
            </div>
          )}
          ...
          {quizStarted && !quizResult && (
            <div className="sys-quiz-container">
              <div className="sys-quiz-progress">
                <div
                  className="sys-quiz-progress-fill"
              ...
              {QUIZ_QUESTIONS.map((q, qi) => (
                <div
                  key={q.id}
                  className="sys-quiz-question"
                  style={{ display: qi === quizStep ? 'block' : 'none' }}
                >
                    ...
                    <div className="sys-quiz-options">
                      {q.options.map((opt) => {
                        ...
                        return (
                          <div key={opt.value}>
                            <button
                              className={`sys-quiz-option ${isSelected ? 'selected' : ''}`}
                              onClick={() => {
                            ...
                            {isSelected && opt.hasSubOptions && (
                              <div className="sys-quiz-sub-options">
                                {opt.subOptions.map((sub) => (
                                  <button
                                    key={sub}
                                    className={`sys-quiz-sub ${quizAnswers[q.id]?.sub === sub ? 'selected' : ''}`}
                                    onClick={() => {
                                      const na = {
                                        ...quizAnswers,
                                        [q.id]: { value: opt.value, sub },
                                      }
                                      setQuizAnswers(na)
                                      setTimeout(() => {
                                        if (quizStep < QUIZ_QUESTIONS.length - 1)
                            ...
                            {isSelected && opt.hasInput && (
                              <div className="sys-quiz-input-wrap">
                                <input
                                  className="sys-quiz-input"
                                  placeholder={opt.inputPlaceholder}
                                  value={quizAnswers[q.id]?.input || ''}
                                  onChange={(e) =>
                                    setQuizAnswers({
                                      ...quizAnswers,
                                      [q.id]: { value: opt.value, input: e.target.value },
                                    })
                                  }
                                  autoFocus
                                />
                            ...
                            {isSelected && opt.hasCounter && (
                              <div className="sys-quiz-counter">
                                <button
                                  className="sys-quiz-counter-btn"
                                  onClick={(e) => {
                                    e.stopPropagation()
                                    const cur = quizAnswers[q.id]?.count || opt.min
                                    if (cur > opt.min)
                                      setQuizAnswers({
                                        ...quizAnswers,
                                        [q.id]: { value: opt.value, count: cur - 1 },
                                      })
                                  }}
                                >
                                  −
                                </button>
                                <span className="sys-quiz-counter-val">
                                  {quizAnswers[q.id]?.count || opt.min}
                                </span>
                                <button
                                  className="sys-quiz-counter-btn"
                                  onClick={(e) => {
                    ...
                    <div className="sys-quiz-options" style={{ flexWrap: 'wrap' }}>
                      {q.options.map((opt) => {
                        ...
                        return (
                          <button
                            key={opt.value}
                            className={`sys-quiz-option ${isSel ? 'selected' : ''} ${q.id === 'avoid' ? 'teal' : ''}`}
                            onClick={() => {
                              let ns
                              if (isSel) ns = sels.filter((v) => v !== opt.value)
                              else if (sels.length < q.maxSelect) ns = [...sels, opt.value]
                              else return
                  ...
                  {q.type === 'text' && (
                    <input
                      ...
                      value={quizAnswers[q.id]?.input || ''}
                      onChange={(e) =>
                        setQuizAnswers({ ...quizAnswers, [q.id]: { input: e.target.value } })
                      }
                    />
                  )}
                  ...
                  <div className="sys-quiz-nav">
                    {quizStep > 0 && (
                      <button className="sys-quiz-back" onClick={() => setQuizStep(quizStep - 1)}>
                        ← Back
                      </button>
                    )}
                    <div style={{ flex: 1 }} />
                    ...
                    {(q.type === 'multi' ||
                      ...
                      (q.type === 'choice' &&
                        ...
                        (q.options.find((o) => o.value === quizAnswers[q.id]?.value)?.hasInput ||
                          q.options.find((o) => o.value === quizAnswers[q.id]?.value)
                            ?.hasCounter))) && (
                      <button
                        className="sys-quiz-next"
                        onClick={() => {
                          if (quizStep < QUIZ_QUESTIONS.length - 1) setQuizStep(quizStep + 1)
                          else computeResult(quizAnswers)
                        }}
            ...
            <Reveal type="scale">
              <div className="sys-quiz-result">
                <div className="sys-quiz-result-bg">
                  {DEST_IMAGES[quizResult.pick] && (
                    <img
                      src={DEST_IMAGES[quizResult.pick]}
                      alt=""
                ...
                <div className="sys-quiz-result-content">
                  ...
                  {quizResult.alt && (
                    <p className="sys-quiz-result-alt">
                      Also consider: <strong>{quizResult.alt}</strong> — {quizResult.altWhy}
                    </p>
                  )}
                  <div className="sys-quiz-result-actions">
                    <button
                      className="sys-quiz-cta-gold"
                      onClick={() => {
                        if (onQuizComplete) {
                          onQuizComplete({
                            destination: quizResult.pick,
                            timing:
                              quizAnswers.timing?.input ||
                              quizAnswers.timing?.sub ||
                              quizAnswers.timing?.value ||
                              '',
                            group: quizAnswers.group?.count
                              ? `${quizAnswers.group.value} (${quizAnswers.group.count})`
                              : quizAnswers.group?.value || '',

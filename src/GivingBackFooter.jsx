...
const CAUSES = [
  {
    ...
    charity: 'Ginny L. Clements Institute',
        ...
        <div className="gb-inner">
          <Reveal type="fade">
            <blockquote className="gb-philosophy">
              "If you allow yourself to not stress about the small things, the lifelong memories
              typically create themselves without even thinking about it."
            </blockquote>
          ...
          <Reveal delay={200}>
            <p className="gb-statement">
              Every trip we plan through 2026 is free. Any donations go straight to these causes. We
              don't take a cut.
            </p>
